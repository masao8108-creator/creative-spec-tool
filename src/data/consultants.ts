...
export const CONSULTANTS: Consultant[] = [
  ...
  { name: "차원주", nickname: "보험헬퍼", tagline: "고객의 입장에서 최선의 보험을 설계합니다", phone: "010-2165-0546", { name: "차원주", nickname: "보험헬퍼", tagline: "고객의 입장에서 최선의 보험을 설계합니다", phone: "010-2165-0546", kakaoChat: "https://open.kakao.com/o/s1OwLbhi", email: "", instagram: null, blog: null, specialties: ["신규상담", "보장분석", "리모델링", "보상청구"], featured: false, profileImage: "/profiles/cha-wonju.jpg", yearsOfExperience: 1 },, email: "", instagram: null, blog: null, specialties: ["신규상담", "보장분석", "리모델링", "보상청구"], featured: false, profileImage: "/profiles/cha-wonju.jpg", yearsOfExperience: 1 },
